  ...
  >
    <div class="mb-4" id="reset-dialog-description">
      <div class="mb-3 flex items-center gap-3">
        <div class="flex-shrink-0">
          <svg class="h-6 w-6 text-brand-600 dark:text-brand-400" version="1.1" viewBox="0 0 1200 1200" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flex justify-end gap-3">
      <button
        ...
        class="rounded-full bg-brand-300 dark:bg-brand-700 px-4 py-2 text-sm font-semibold text-brand-900 dark:text-brand-100 hover:bg-brand-300/90 dark:hover:bg-brand-600 focus:outline-none focus:ring-2 focus:ring-brand-500"
        on:click={onCancel}
      >
        Cancel
      </button>
      <button
        type="button"
        class="rounded-full border bg-red-200 dark:bg-red-900 border-red-600 dark:border-red-400 px-4 py-2 text-sm font-semibold text-red-950 dark:text-red-100 hover:bg-red-50 dark:hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-red-500"
        on:click={onConfirm}
      >
        Reset All Data
      </button>
