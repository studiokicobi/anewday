...
<div class="space-y-6">
  <div>
    ...
    <div class="space-y-6">
      ...
      <!-- Export Button -->
      <div>
        <button type="button" class="rounded-full bg-brand-200 dark:bg-brand-700 px-5 py-2 text-sm font-base text-brand-900 dark:text-brand-100 hover:bg-brand-300 dark:hover:bg-brand-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500" on:click={onExport}>
          Export data
        </button>
      ...
      <!-- Import Button -->
      <div>
        <label class="rounded-full px-5 py-2 bg-brand-200 dark:bg-brand-700 text-sm font-base text-brand-900 dark:text-brand-100 hover:bg-brand-300 dark:hover:bg-brand-600 cursor-pointer inline-flex focus-within:outline-none focus-within:ring-2 focus-within:ring-brand-500">
          Import data
