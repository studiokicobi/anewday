...
- **Pointer gestures**: Drag-and-drop reordering is currently pointer-only; keyboard users can add/toggle/delete tasks but cannot reorder without assistive technology.
